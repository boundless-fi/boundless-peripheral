...
library YokaiLibrary {
            ...
            uint256(
                keccak256(
                    abi.encodePacked(
                        ...
                        hex'543cecfb9368d47418ee4aa64b52176cb0eda4597346f08445ec68f6f81d7d5d' // init code hash
                    )
                )
            )
        );
    ...
    function getReserves(
        ...
        // (uint256 reserve0, uint256 reserve1, ) = IYokaiPair(pairFor(factory, tokenA, tokenB)).getReserves();
        (uint256 reserve0, uint256 reserve1, ) = IYokaiPair(IYokaiFactory(factory).getPair(tokenA, tokenB))
            .getReserves();
